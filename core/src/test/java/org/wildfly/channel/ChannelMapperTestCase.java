...
public class ChannelMapperTestCase {
    ...
    public void testWriteReadChannel() throws Exception {
        final Channel channel = new Channel("test_name", "test_desc", new Vendor("test_vendor_name", Vendor.Support.COMMUNITY), Collections.emptyList(), Collections.emptyList(), new Channel.ManifestRef(null, "test.channels:channel"));
    ...
    public void testWriteMultipleChannels() throws Exception {
        ...
        final Channel channel1 = new Channel("test_name_1", "test_desc", new Vendor("test_vendor_name", Vendor.Support.COMMUNITY), Arrays.asList(req), Collections.emptyList(), new Channel.ManifestRef(null, "test.channels:channel"));
        final Channel channel2 = new Channel("test_name_2", "test_desc", new Vendor("test_vendor_name", Vendor.Support.COMMUNITY), Collections.emptyList(), Collections.emptyList(), new Channel.ManifestRef("http://test.channels/channels", null));
