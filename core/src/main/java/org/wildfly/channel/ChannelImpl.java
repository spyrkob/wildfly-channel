...
class ChannelImpl implements AutoCloseable {
    ...
    void init(MavenVersionsResolver.Factory factory, List<ChannelImpl> channels) {
        ...
        if (channelDefinition.getBlocklistCoordinate() != null) {
            final BlocklistCoordinate blocklistCoordinate = channelDefinition.getBlocklistCoordinate();
            final String groupId = blocklistCoordinate.getGroupId();
            final String artifactId = blocklistCoordinate.getArtifactId();
